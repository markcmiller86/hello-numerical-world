...
"--------------------------------\n"
"\n"
"The example script heat_compare.py demonstrates how to use this module.\n"
...
"\n"
"The example script heat_compare.py demonstrates how to compare the FTCS and DuFort-Frankel algorithms.\n"
"It initializes two solutions, runs the simulations, and retrieves the results.\n"
"The script then visualizes the results using the matplotlib library.\n"
"\n"
...
"--------------------------\n"
"\n"
"[NOTE: WILL BE ADDED AT A LATER DATE]"
